...
router.get('/', async function(req, res) {
		...
		//파라미터 설정
    url = "https://apis.data.go.kr/B552584/ArpltnInforInqireSvc/getCtprvnRltmMesureDnsty?serviceKey=8MYiiba20KybGCisWb1v9%2BPlWCqLOQzNujEWBgOY6mrmFa3kG99tqWrl%2FEk9Qfny34WTZCglo%2BAbQj1eKznt8w%3D%3D&returnType=xml&numOfRows=100&pageNo=1&sidoName=%EB%8C%80%EA%B5%AC&ver=1.0";
    serviceKey = "8MYiiba20KybGCisWb1v9%2BPlWCqLOQzNujEWBgOY6mrmFa3kG99tqWrl%2FEk9Qfny34WTZCglo%2BAbQj1eKznt8w%3D%3D";
    ...
    try {
        var context = new Array();
				//axios로 HTTP GET 요청
        const result = await axios.get(url + queryParams); //await 기다려야 다음 데이터 값으로 파싱하거나 할 수 있다.
				//응답 데이터 저장
